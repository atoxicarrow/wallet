          ...
          <div key={goal.id} className="bg-[#1C1C1E] p-6 rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-[10px] text-[#34C759] font-black uppercase mt-1">Meta: ${goal.target.toLocaleString()}</p>
              </div>
            ...
            <div className="flex items-end gap-2 mb-4">
              <span className="text-3xl font-black text-[#F5F5F5]">${goal.current.toLocaleString()}</span>
